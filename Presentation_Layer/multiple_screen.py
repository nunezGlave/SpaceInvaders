...
if __name__ == '__main__':
    ...
    match optionMenu:
        case -2:
            player1 = [{'typePlayer': 0, 'name': 'Player-1'},{'typePlayer': 1, 'name': 'Player-2'}]
            gameScreen3 = SP1(1, player1, difficulty, screen.width, screen.height)
        case -1:
            player1 = [{'typePlayer': 0, 'name': 'Player-1'},{'typePlayer': 1, 'name': 'Player-2'}]
            player2 = [{'typePlayer': 0, 'name': 'AC3'},{'typePlayer': 1, 'name': 'DQN'}]
            gameScreen1 = SP1(2, player1, difficulty, screen.halfWidth, screen.height)
            gameScreen2 = SP1(2, player2, difficulty, screen.halfWidth, screen.height, screen.halfWidth)        
        case 0:
            player = [{'typePlayer': 0, 'name': 'Player-1'}]
            gameScreen = SP1(1, player, difficulty, screen.width, screen.height)
        case 1: 
            fullScreen = SP2(modeGame, 0, screen, screen.width, screen.height)            
        case 2:
